package com.anber.sdkopenglrecord;
...
import com.anber.sdkopenglrecord.render.GrayCameraRender;
...
public class OpenGLRecordActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        int id = v.getId();
        Button btn = (Button) v;
        if (id == R.id.btn_gl_record_record) {
        ...
        } else if (id == R.id.btn_gl_record_play) {
