...
import com.anber.work.ui.activity.camerastudy.render.CameraRender;
import com.anber.work.ui.activity.camerastudy.render.CameraRender2;
import com.goldze.base.utils.CameraUtils;
import com.goldze.base.utils.ScreenUtils;

import java.io.IOException;

import static com.goldze.base.utils.GlUtil.createCameraTextureID;

/**
 * 一个Activity上四个GLSurfaceView同时预览摄像头返回的图像
 * blog：http://blog.sina.com.cn/s/blog_68dc52970102wjhy.html
 */
public class FourGLSurfaceViewActivity extends AppCompatActivity {
    ...
    private void initCameraParameters() {
        ...
        CameraUtils.setCameraDisplayOrientation(FourGLSurfaceViewActivity.this, Camera.CameraInfo.CAMERA_FACING_FRONT, mCamera);
