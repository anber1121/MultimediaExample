package com.anber.work.ui.activity.camerastudy.render;
 ...
 */
public class CameraRender2 implements GLSurfaceView.Renderer {
    ...
    public CameraRender2(Context context, SurfaceTexture surfaceTexture, int textureID) {
